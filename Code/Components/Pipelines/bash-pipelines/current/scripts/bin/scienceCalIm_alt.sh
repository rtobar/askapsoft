#!/bin/bash -l
#
# Process the science field observations using the alternate new imager
# : split out per beam, flag,
...
echo "Using alternate imager: setting up and calibrating the science observation"
