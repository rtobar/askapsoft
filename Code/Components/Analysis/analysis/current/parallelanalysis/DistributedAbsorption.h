...
///
#ifndef ASKAP_DISTRIB_ABSORPTION_H_
...
/// @brief Distributed handling of HI absorption-line catalogues.
...
/// create the absorption catalogue and related processing on their
/// local list of objects, and then return the list of absorption catalogue
/// entries to the master. The master can then access this for writing
/// out.
class DistributedAbsorption : public DistributedParameteriserBase {
    public:
    ...
    protected:
        ...
        std::vector<CasdaAbsorptionObject> itsOutputList;
