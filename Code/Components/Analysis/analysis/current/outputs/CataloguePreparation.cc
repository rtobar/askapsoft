...
namespace analysis {
    ...
    duchamp::Catalogues::CatalogueSpecification IslandCatalogue(duchamp::FitsHeader &header)
    {
        ...
        newSpec.addColumn("NUM","island_id", "--", 6, 0,"meta.id;meta.main","char","col_island_id","");
        newSpec.addColumn("NAME","island_name","",8,0,"meta.id","char","col_island_name","");
        newSpec.addColumn("NCOMP","n_components","",5,0,"meta.number","int","col_num_components","");
        newSpec.addColumn("RA","ra_hms_cont","",11,0,"pos.eq.ra","char","col_ra","J2000");
        newSpec.addColumn("DEC", "dec_dms_cont","",11,0,"pos.eq.dec","char","col_dec","J2000");
        ...
        newSpec.addColumn("VEL","freq","["+header.getSpectralUnits()+"]",11,prVel,"em.freq","float","col_freq","");
        newSpec.addColumn("MAJ","maj_axis","[arcsec]",6,prWpos,"phys.angSize.smajAxis;em.radio","float","col_maj","");
        newSpec.addColumn("MIN","min_axis","[arcsec]",6,prWpos,"phys.angSize.sminAxis;em.radio","float","col_min","");
        newSpec.addColumn("PA","pos_ang","[deg]",7,prWpos,"phys.angSize;pos.posAng;em.radio","float","col_pa","");
        newSpec.addColumn("FINT","flux_int","["+header.getIntFluxUnits()+"]",10,prFlux,"phot.flux.density.integrated;em.radio","float","col_fint","");
        newSpec.addColumn("FPEAK","flux_peak","["+header.getFluxUnits()+"]",9,prFlux,"phot.flux.density;stat.max;em.radio","float","col_fpeak","");
        newSpec.addColumn("X1","x_min","",4,0,"pos.cartesian.x;stat.min","int","col_x1","");
        newSpec.addColumn("X2","x_max","",4,0,"pos.cartesian.x;stat.max","int","col_x2","");
        newSpec.addColumn("Y1","y_min","",4,0,"pos.cartesian.y;stat.min","int","col_y1","");
        newSpec.addColumn("Y2","y_max","",4,0,"pos.cartesian.y;stat.max","int","col_y2","");
        newSpec.addColumn("SPATSIZE","n_pix","",9,0,"phys.angArea;instr.pixel;meta.number","int","col_npix","");
        newSpec.addColumn("XAV","x_ave","",6,prXYZ,"pos.cartesian.x;stat.mean","float","col_xav","");
        newSpec.addColumn("YAV","y_ave","",6,prXYZ,"pos.cartesian.y;stat.mean","float","col_yav","");
        newSpec.addColumn("XCENT","x_cen","",7,prXYZ,"pos.cartesian.x;askap:stat.centroid","float","col_xcent","");
        newSpec.addColumn("YCENT","y_cen","",7,prXYZ,"pos.cartesian.y;askap:stat.centroid","float","col_ycent","");
        newSpec.addColumn("XPEAK","x_peak","",7,prXYZ,"pos.cartesian.x;phot.flux;stat.max","int","col_xpeak","");
        newSpec.addColumn("YPEAK","y_peak","",7,prXYZ,"pos.cartesian.y;phot.flux;stat.max","int","col_ypeak","");
    ...
    duchamp::Catalogues::CatalogueSpecification CASDACatalogue(duchamp::FitsHeader &header)
    {
        ...
        newSpec.addColumn("NAME","component_name","",8,0,"meta.id","char","col_component_name","");
        newSpec.addColumn("RA","ra_hms_cont","",11,0,"pos.eq.ra","char","col_ra","J2000");
