...
namespace analysis {
    ...
    /// Extract results from a 2D Gaussian suitable for printing to a catalogue.
    ...
    /// Define an island catalogue spec based on the Duchamp catalogue specification
    duchamp::Catalogues::CatalogueSpecification
        IslandCatalogue(duchamp::FitsHeader &header);
    
    /// Define a component catalogue specification conforming to CASDA requirements
    duchamp::Catalogues::CatalogueSpecification
        CASDACatalogue(duchamp::FitsHeader &header);

    /// Define a component catalogue specification
    duchamp::Catalogues::CatalogueSpecification
        fullCatalogue(duchamp::Catalogues::CatalogueSpecification inputSpec,
                      duchamp::FitsHeader &header);

    /// Set up the columns according to the contents of the catalogue
