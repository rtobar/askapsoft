...
LOFAR::BlobOStream& operator<<(LOFAR::BlobOStream& blob, CasdaPolarisationEntry& src)
{
    ...
    src.itsSBid = s; blob << s; 
    src.itsIDbase = s; blob << s; 
    // from CasdaPolarisationEntry.h
    src.itsComponentID = s; blob << s; 
    src.itsName = s; blob << s; 
    src.itsRA = d; blob << d; 
    src.itsDec = d; blob << d; 
    src.itsFluxImedian = d; blob << d; 
    src.itsFluxQmedian = d; blob << d; 
    src.itsFluxUmedian = d; blob << d; 
    src.itsFluxVmedian = d; blob << d; 
    src.itsRmsI = d; blob << d; 
    src.itsRmsQ = d; blob << d; 
    src.itsRmsU = d; blob << d; 
    src.itsRmsV = d; blob << d; 
    src.itsPolyCoeff0 = d; blob << d; 
    src.itsPolyCoeff1 = d; blob << d; 
    src.itsPolyCoeff2 = d; blob << d; 
    src.itsPolyCoeff3 = d; blob << d; 
    src.itsPolyCoeff4 = d; blob << d; 
    src.itsLambdaSqRef = d; blob << d; 
    src.itsRmsfFwhm = d; blob << d; 
    src.itsDetectionThreshold = d; blob << d; 
    src.itsDebiasThreshold = d; blob << d;
    src.itsPintPeak = v; blob << v;
    src.itsPintPeakDebias = d; blob << d;
    src.itsPintPeakFit = v; blob << v;
    src.itsPintPeakFitDebias = d; blob << d;
    src.itsPintFitSNR = v; blob << v;
    src.itsPhiPeak = v; blob << v;
    src.itsPhiPeakFit = v; blob << v;
    src.itsPolAngleRef = v; blob << v;
    src.itsPolAngleZero = v; blob << v;
    src.itsFracPol = v; blob << v;
    src.itsComplexity = d; blob << d;
    src.itsComplexity_screen = d; blob << d;
    src.itsFlagDetection = u; blob << u;
    src.itsFlagEdge = u; blob << u;
    src.itsFlag3 = u; blob << u;
    src.itsFlag4 = u; blob << u;
